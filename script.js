      ...
      let response = await fetch(
        "https://striveschool-api.herokuapp.com/api/product/",
        {
          ...
          headers: new Headers({
            ...
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZmFiZGZkMjRiY2RlMTAwMTc2MTZhYTUiLCJpYXQiOjE2MDUxNjgzNzksImV4cCI6MTYwNjM3Nzk3OX0.tl61sgw4EimhtGv9JPssrbLiJ_umWM0BnvSKouAefYc",
          }),
        }
      );
      if (response.ok) {
